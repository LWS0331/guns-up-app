...
/* ─── Cool / decompression / volume / camera ────────────────── */

// Snowflake — 6-pointed, used for cooldown / decompression cues.
export const Snowflake = make(
  <g>
...
// Volume on — speaker + sound waves. Used for TTS-on indicator.
export const Volume = make(
  <g>
...
// Volume muted — speaker with X. Used for TTS-off indicator.
export const VolumeMute = make(
  <g>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" fill="currentColor" stroke="none" />
...
// Camera — image attach affordance in chat composer.
...
// Sword — for "battle plan" CTAs and destructive plan-replacement
// actions. Stroke-based; the tactical military read.
export const Sword = make(
  <g>
    <line x1="14.5" y1="17.5" x2="3" y2="6" />
    <path d="M13 19l6-6" />
    <path d="M16 16l4-4-7-7-4 4z" />
